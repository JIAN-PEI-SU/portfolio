 ...
 * Original file: /npm/@triggerjs/trigger@1.0.8/dist/bundle.js
 *
 ...
 */ ;(() => {
    var t = {
                ...
                function o(t) {
                    if ('string' == typeof t) {
                        if (t.indexOf(',') > -1) {
                            var e = t.split(',')
                            if (4 !== e.length)
                                throw new Error('Bezier function expected 4 arguments, but got '.concat(e.length, '.'))
                            return e
                        }
                        if (!n.Si.hasOwnProperty(t))
            ...
            921: (t, e, r) => {
                'use strict'
                function n(t) {
                    var e = { mode: 'retain', values: [] }
                    return (
                        'string' == typeof t &&
                            '' !== t.trim() &&
                            ('!' === t.substring(t.length - 1) &&
                                ((e.mode = 'exact'), (t = t.substring(0, t.length - 1))),
                            (t = t.replace(/!/g, '')),
                            (e.values = t.split(',').map(function (t) {
                    ...
                    return (
                        ...
                        (function (t, e) {
                            ...
                            try {
                                for (
                                    r = r.call(t);
                                    !(u = (n = r.next()).done) && (i.push(n.value), !e || i.length !== e);
                                    u = !0
                                );
                            } catch (t) {
                                ;(a = !0), (o = t)
                                ...
                                if (2 === o.length)
                                    if (o[0].indexOf(',') > -1)
                                        ...
                                        for (
                                            ...
                                            (c = Number(c.toFixed((null == e ? void 0 : e.decimals) || 2))),
                                                (r[c] = o[1].trim()),
                                                (c += (null == e ? void 0 : e.increment) || 0.01)
            ...
            424: (t, e, r) => {
                ...
                function o(t) {
                    return (
                        t || console.warn(''.concat((0, n.G)(), 'name is not set')),
                        '--' === t.substring(0, 2) ? t : '--'.concat(t)
                    )
                }
            },
            146: (t, e, r) => {
            ...
            105: (t, e, r) => {
                ...
                r.d(e, { Si: () => u, $p: () => a })
                i(0.25, 0.1, 0.25, 1), i(0.42, 0, 1, 1), i(0, 0, 0.58, 1), i(0.42, 0, 0.58, 1)
                var u = {
    ...
    ;(() => {
        ...
        function u(r, n, i) {
            ...
            var c = (function (t, r, n) {
                    ...
                    var o = t
                    for (; (o = o.parentElement) !== document.body; ) if (o.hasAttribute(r)) return o
                    return t
                })(r, n, u),
        ...
        i.keys().map(function (t) {
            var e,
                r = null === (e = t.match(/tg-[^.]+/)) || void 0 === e ? void 0 : e[0]
            r && (o[r] = i(t))
        })
        var a = r(105)
        function c(e) {
            ...
            return {
                ...
                steps: d,
                step: m,
                mapping: u(e, ''.concat(n, 'map'), { increment: b, decimals: w }),
                filter: p,
                edge: v,
                range: y,
                increment: b,
            ...
            t.forEach(function (t) {
                ...
                if ('--_' !== f) {
                    var b,
                        h =
                            'cover' === p
                                ? Math.min(Math.max((r + n - o) / (n + i), 0), 1)
                                : Math.min(Math.max((r - o) / (i - n), 0), 1)
                    ;(h = y ? (0, a.$p)(y, h) : h),
                        (b = +(d + Math.floor((c + 1) * h) * u * s).toFixed(l)),
                        g.values.length > 0 && !g.values.includes(b)
                            ? 'exact' === g.mode && ((t.lastValue = null), e.style.removeProperty(f))
                            : (void 0 !== m[b] && (b = m[b]),
                              v != b &&
                                  (e.style.setProperty(f, ''.concat(b)),
                                  e.dispatchEvent(new CustomEvent('tg', { target: e, detail: { value: b } })),
                                  (t.lastValue = b)))
                }
            })
        }
        var s = { root: null, rootMargin: '0px', threshold: 0 }
        function f(e, r) {
            ...
            document.querySelectorAll('['.concat(n, 'name]')).forEach(function (t) {
                var r = t.getBoundingClientRect(),
                    o = r.top,
                    i = r.height
                t.style.setProperty('--'.concat(n, 'top'), ''.concat(o + window.scrollY)),
                    t.style.setProperty('--'.concat(n, 'height'), ''.concat(i)),
                    e && e.observe(t)
            }),
            ...
            ;(t = function (t) {
                ...
                (p =
                    'undefined' == typeof IntersectionObserver
                        ? (console.warn('IntersectionObserver is not supported in this browser'), null)
                    ...
                    ? (v(),
                      window.addEventListener('DOMContentLoaded', function () {
                          f(p),
                              setTimeout(function () {
                                  l(
                                      d(document.querySelectorAll('['.concat((0, t.G)(), 'name]'))).map(function (t) {
                                          return c(t)
                                      })
                                  )
                              })
